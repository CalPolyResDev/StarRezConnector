...
from .utils import Resident, reverse_address_lookup
...
class StarRezBaseConnection(object):
    ...
    def lookupResident(self, name_web=None):
        return Resident(self.api_instance, name_web)

    def reverse_lookup(self, community="", building="", room=""):
        return reverse_address_lookup(community, building, room, self.api_instance)
